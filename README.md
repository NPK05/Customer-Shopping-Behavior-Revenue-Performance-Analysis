...
## 📌 Overview
This project analyzes **customer shopping behavior and revenue performance** to uncover key factors influencing purchasing patterns.

The project combines:
- **Python** for data preparation
- **PostgreSQL** for SQL-based business analysis
...
| 📦 Purchase Behavior | Purchase Frequency, Seasonal Trends |
...
Run the SQL scripts to perform the business analysis.

### 5️⃣ Open the Power BI Dashboard
Open the **.pbix file** to explore the interactive dashboard visualizations.
